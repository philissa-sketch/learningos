...
const MG = await import(moduleUrl('src/lib/missionGrades.js'));
const { MISSION_PROPOSALS, MISSION_RUBRIC_CRITERIA, MISSION_QUARTERS } =
  await import(moduleUrl('src/academies/lamar/data/admin/missionEvaluations.js'));
const { SUBJECT_LABELS, PARTICIPATION_SUBJECTS } = await import(moduleUrl('src/academies/lamar/subjects.js'));
