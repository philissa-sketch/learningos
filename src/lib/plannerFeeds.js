...
import { isHoliday as slotIsHoliday, isSchoolDay as slotIsSchoolDay } from '../content/slots/timetable.js';
...
const isHoliday = (...args) => slotIsHoliday(academyContent(), ...args);
