...
export const MINI_LESSONS = [
  ...
  { n: 5, kind: 'sentence', khanUnit: 6, task: 'closed', title: 'A sentence starts with a capital', plain: 'The first letter of a sentence is a capital.', example: 'the sky is gray. → The sky is gray.', tryIt: 'Fix it: the pot fell.', answer: 'The pot fell.' },
  { n: 6, kind: 'sentence', khanUnit: 6, task: 'closed', title: 'The full stop at the end', plain: 'A telling sentence ends with a full stop.', example: 'The pot fell.', tryIt: 'Fix it: The sky is gray', answer: 'The sky is gray.' },
  { n: 7, kind: 'sentence', khanUnit: 6, task: 'closed', title: 'The question mark', plain: 'A sentence that asks ends with a question mark.', example: 'Did the pot fall?', tryIt: 'Turn it into an asking sentence: The sky is gray.', answer: 'Is the sky gray?' },
  ...
  { n: 62, kind: 'writing', task: 'closed', title: 'Show it, do not name it', plain: 'Instead of naming a feeling, say what you saw.', example: 'Not it was sad. The leaves had gone gray and soft.', tryIt: 'Show it: the plant was sad.', answer: 'The leaves had gone gray and soft.' },
