...
export const HUMANBODY_M12_BANK = [
  ...
  { id: 't-bodym1201c', lesson: 'body-m12-01', prompt: '1200 milliliters written in liters is:', choices: ['12 liters', '1.2 liters', '120 liters', '0.12 liters'], answer: 1, feedback: ['Ten times too many.', null, 'A hundred times too many.', 'Ten times too few.'], why: 'A thousand milliliters make a liter.' },
  { id: 't-bodym1201d', lesson: 'body-m12-01', prompt: '2000 milliliters is the same as:', choices: ['20 liters', '200 liters', 'Half a liter', '2 liters'], answer: 3, feedback: ['Ten times too many.', 'A hundred times too many.', 'Far too little.', null], why: '2000 ÷ 1000 = 2.' },
  ...
  { id: 't-bodym1201j', lesson: 'body-m12-01', prompt: 'Filling a jug in stages to reach 1200 ml practices:', choices: ['Adding volumes together', 'Weighing', 'Telling time', 'Measuring length'], answer: 0, feedback: [null, 'Nothing is weighed.', 'No clock is used.', 'No ruler is used.'], why: 'Several pours, one total.' },
  ...
  { id: 't-bodym1202c', lesson: 'body-m12-02', prompt: '40 millimeters written in centimeters is:', choices: ['400 cm', '4 cm', '0.4 cm', '40 cm'], answer: 1, feedback: ['Far too big.', null, 'Ten times too small.', 'The unit did not change.'], why: 'Ten millimeters make one centimeter.' },
  { id: 't-bodym1202d', lesson: 'body-m12-02', prompt: '70 millimeters written in centimeters is:', choices: ['700 cm', '0.7 cm', '70 cm', '7 cm'], answer: 3, feedback: ['Far too big.', 'Ten times too small.', 'Unit unchanged.', null], why: '70 ÷ 10 = 7.' },
  { id: 't-bodym1202e', lesson: 'body-m12-02', prompt: '5 centimeters written in millimeters is:', choices: ['50 mm', '5 mm', '500 mm', '0.5 mm'], answer: 0, feedback: [null, 'Unit unchanged.', 'Ten times too many.', 'Far too small.'], why: '5 × 10 = 50.' },
  { id: 't-bodym1202f', lesson: 'body-m12-02', prompt: 'The thick bundle of nerves inside your spine is the:', choices: ['Windpipe', 'Aorta', 'Spinal cord', 'Skull'], answer: 2, feedback: ['That carries air.', 'That carries blood.', null, 'That is bone.'], why: 'Branches leave it like roads leave a highway.' },
  ...
  { id: 't-bodym1204h', lesson: 'body-m12-04', prompt: 'In the pointing activity she measures:', choices: ['The gap between two marks', 'How clever she is', 'How fast she moves', 'Her weight'], answer: 0, feedback: [null, 'Nothing about that is measured.', 'Speed is not measured.', 'Nothing is weighed.'], why: 'A length, in centimeters, five times.' },
