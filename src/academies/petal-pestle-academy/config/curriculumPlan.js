...
export const SOCIAL_STANDARD_OWNERS = [
  ...
  { element: 'SS4G1a', course: 'social', quarter: 2, vehicle: 'Coastal Plain, Great Plains, Continental Divide, Gulf, Mississippi, Great Lakes — found and labeled.' },
...
export const STANDARD_OWNERS = [
  ...
  { element: 'S4E3a', course: 'herbalism', quarter: 2, vehicle: 'Ice, water and vapor in a jar on the windowsill.' },
